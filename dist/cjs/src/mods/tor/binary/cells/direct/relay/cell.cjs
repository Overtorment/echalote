...
var cell$1 = require('../../relayed/relay_data/cell.cjs');

exports.RelayCell = void 0;
(function (RelayCell) {
    RelayCell.HEAD_LEN = 1 + 2 + 2 + 4 + 2;
    RelayCell.DATA_LEN = cell.Cell.PAYLOAD_LEN - RelayCell.HEAD_LEN;
    RelayCell.command = 3;
    class Raw {
        circuit;
        stream;
        ...
        cellOrThrow() {
            ...
            try {
                ...
                const digest = tslib_es6.__addDisposableResource(env_1, exit.forward_digest.finalizeOrThrow(), false);
                const digest20 = digest.bytes.slice();
                if (this.rcommand === cell$1.RelayDataCell.rcommand) {
                    if (exit.package % 100 === 1)
                        exit.digests.push(digest20);
                    exit.package--;
                }
                cursor$1.offset = digestOffset;
                cursor$1.writeOrThrow(digest20.subarray(0, 4));
                ...
                return new cell.Cell.Circuitful(this.circuit, RelayCell.command, fragment);
            }
            catch (e_1) {
                env_1.error = e_1;
                env_1.hasError = true;
            ...
            try {
                ...
                for (const target of cell$1.circuit.targets) {
                    ...
                    try {
                        ...
                        return new Raw(cell$1.circuit, stream, rcommand, data, digest20);
                    }
                    catch (e_2) {
                        env_3.error = e_2;
                        env_3.hasError = true;
    ...
    RelayCell.Streamless = Streamless;
})(exports.RelayCell || (exports.RelayCell = {}));
