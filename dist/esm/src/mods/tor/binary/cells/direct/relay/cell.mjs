...
import { ExpectedCircuitError, UnrecognisedRelayCellError, InvalidRelayCommandError, ExpectedStreamError, UnexpectedStreamError } from '../../errors.mjs';
import { RelayDataCell } from '../../relayed/relay_data/cell.mjs';

var RelayCell;
(function (RelayCell) {
    RelayCell.HEAD_LEN = 1 + 2 + 2 + 4 + 2;
    RelayCell.DATA_LEN = Cell.PAYLOAD_LEN - RelayCell.HEAD_LEN;
    RelayCell.command = 3;
    class Raw {
        circuit;
        stream;
        ...
        cellOrThrow() {
            ...
            try {
                ...
                const digest = __addDisposableResource(env_1, exit.forward_digest.finalizeOrThrow(), false);
